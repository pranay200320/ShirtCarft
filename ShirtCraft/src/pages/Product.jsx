...
const Product = () => {
  ...
  return productData ? (
    <div
      data-aos="fade-up"
      className="border-t pt-10 transition-opacity ease-in duration-500 opacity-1"
    >
      <div className="flex gap-12 sm:gap-12 flex-col sm:flex-row">
        ...
        <div data-aos="fade-left" className="flex-1">
          ...
          <button
            ...
            className="bg-black text-white px-8 py-3 text-sm active:bg-gray-400-700"
          >
            ADD TO CART
          </button>
          <hr className="mt-8" />
